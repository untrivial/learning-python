...
class LinkedList:
    ...
    def count_occurences_recursive(self, node, data):
        ...
        if node.data == data:
            ...
            return self.count_occurences_recursive(node, data)
    ...
    def is_palindrome(self): # string method
        s = ""
        p = self.head
        while p:
            s += p.data
    ...
    def is_palindrome_2(self): # stack method
        p = self.head
        s = []
        while p:
            s.append(p.data)
    ...
    def is_palindrome_3(self): # two pointers
        if self.head:
            p = self.head
            q = self.head
            prev = []
